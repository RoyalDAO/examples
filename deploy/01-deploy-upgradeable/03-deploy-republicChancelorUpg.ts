...
const deployChancelorUpg: DeployFunction = async (
  ...
  console.log(chancelor.address, " UpgradeableChancelor(proxy) address");
  console.log(
  ...
  await save("UpgradeableRepublicChancelor", {
    address: chancelor.address,
    ...artifact,
  });
};

export default deployChancelorUpg;

deployChancelorUpg.tags = ["all", "UpgradeableChancelor"];
